                ...
                <div className="relative bg-surface-1 border border-white/10 rounded-2xl p-3 md:p-4 lg:p-5 hover:border-brand-500/20 transition-all w-full">
                  ...
                  <div className="grid grid-cols-5 gap-2 md:gap-3 lg:gap-4 w-full">
                    ...
                    >
                      ...
                      <div className="relative flex flex-col items-center gap-1.5 md:gap-2 p-2 md:p-3 border border-white/5 rounded-xl hover:border-brand-500/30 transition-all">
                        <div className="p-1.5 md:p-2 bg-surface-2 rounded-lg group-hover/btn:bg-brand-500/20 transition-all">
                          <Edit3 className="w-4 h-4 md:w-5 md:h-5 text-text-tertiary group-hover/btn:text-brand-400 transition-colors" />
                        </div>
                        <span className="text-[10px] md:text-xs font-medium text-text-secondary group-hover/btn:text-brand-400 transition-colors text-center whitespace-nowrap">Details</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="relative flex flex-col items-center gap-1.5 md:gap-2 p-2 md:p-3 border border-white/5 rounded-xl hover:border-accent-purple/30 transition-all">
                        <div className="relative p-1.5 md:p-2 bg-surface-2 rounded-lg group-hover/btn:bg-accent-purple/20 transition-all">
                          <Palette className="w-4 h-4 md:w-5 md:h-5 text-text-tertiary group-hover/btn:text-accent-purple transition-colors" />
                          {book.style_profile && (
                        ...
                        <span className="text-[10px] md:text-xs font-medium text-text-secondary group-hover/btn:text-accent-purple transition-colors text-center whitespace-nowrap">Style</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="relative flex flex-col items-center gap-1.5 md:gap-2 p-2 md:p-3 border border-white/5 rounded-xl hover:border-accent-cyan/30 transition-all">
                        <div className="p-1.5 md:p-2 bg-surface-2 rounded-lg group-hover/btn:bg-accent-cyan/20 transition-all">
                          <BookOpen className="w-4 h-4 md:w-5 md:h-5 text-text-tertiary group-hover/btn:text-accent-cyan transition-colors" />
                        </div>
                        <span className="text-[10px] md:text-xs font-medium text-text-secondary group-hover/btn:text-accent-cyan transition-colors text-center whitespace-nowrap">Outline</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="relative flex flex-col items-center gap-1.5 md:gap-2 p-2 md:p-3 border border-white/5 rounded-xl hover:border-accent-sage/30 transition-all">
                        <div className="p-1.5 md:p-2 bg-surface-2 rounded-lg group-hover/btn:bg-accent-sage/20 transition-all">
                          <Users className="w-4 h-4 md:w-5 md:h-5 text-text-tertiary group-hover/btn:text-accent-sage transition-colors" />
                        </div>
                        <span className="text-[10px] md:text-xs font-medium text-text-secondary group-hover/btn:text-accent-sage transition-colors text-center whitespace-nowrap">Characters</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="relative flex flex-col items-center gap-1.5 md:gap-2 p-2 md:p-3 border border-white/5 rounded-xl hover:border-accent-amber/30 transition-all">
                        <div className="p-1.5 md:p-2 bg-surface-2 rounded-lg group-hover/btn:bg-accent-amber/20 transition-all">
                          <BarChart3 className="w-4 h-4 md:w-5 md:h-5 text-text-tertiary group-hover/btn:text-accent-amber transition-colors" />
                        </div>
                        <span className="text-[10px] md:text-xs font-medium text-text-secondary group-hover/btn:text-accent-amber transition-colors text-center whitespace-nowrap">Analytics</span>
                      </div>
                    </button>
                  </div>
